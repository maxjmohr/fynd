...
VALUES  (1, 11, 'Crime rate index', 'The crime rate safety index provides insights into the prevalence of criminal activities. A higher score refers to lower crime rates.', NULL, 'https://static.thenounproject.com/png/1820946-200.png', now()),
        (1, 12, 'Ecological threat index', 'The ecological threat index gauges the potential harm to the environment. A higher score refers to less ecological threats.', NULL, 'https://static.thenounproject.com/png/6061985-200.png', now()),
        ...
        (1, 17, 'Terrorism index', 'The terrorism index considers various factors related to terrorism risks. A higher score refers to less terrorist threats.', NULL, 'https://static.thenounproject.com/png/1922731-200.png', now()),
        ...
        (3, 35, 'Other dining and drinking', 'The score reflects the amount of other dining and drinking venues at the destination. A higher score refers to more other dining and drinking venues.', NULL, 'https://static.thenounproject.com/png/2850854-200.png', now()),
        (3, 36, 'Cultural and artistic venues', 'The score reflects the amount of cultural and artistic venues such as museums, theatres and cinemas at the destination. A higher score refers to more venues.', NULL, 'https://static.thenounproject.com/png/6488396-200.png', now()),
        (3, 37, 'Leisure venues', 'The score reflects the amount of leisure venues such as spa venues, parks and entertainment venues at the destination. A higher score refers to more venues.', NULL, 'https://static.thenounproject.com/png/6041911-200.png', now()),
        (3, 38, 'Nature', 'The score reflects the amount of natural landmarks such as mountains, forests and national parks at the destination. A higher score refers to more natural landmarks.', NULL, 'https://static.thenounproject.com/png/1452028-200.png', now()),
        (3, 39, 'Tourism sights', 'The score reflects the amount of tourism sights at the destination. A higher score refers to more tourism sights.', NULL, 'https://static.thenounproject.com/png/2675564-200.png', now()),
